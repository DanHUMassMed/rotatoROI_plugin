...
* Run `gradle init`
```
Found existing files in the project directory: '/Users/dan/Code/groovy/rotatoROI_plugin'.
...
Project name (default: rotatoROI_plugin): 
...
application {
    ...
    mainClass = 'com.amywalkerlab.rotato_roi.RotatoROI'
}
